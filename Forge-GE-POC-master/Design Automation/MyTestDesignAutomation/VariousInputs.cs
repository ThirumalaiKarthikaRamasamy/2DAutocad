...
namespace MyTestDesignAutomation
{
    class VariousInputs
    { 
        static string myAppPackName = "MyTest-GE-AppPackName";
        static string myAct_with_Pack_Name = "MyTest-GE-ActivityWithAppPack";
        static string myAppPackBundleName = "MyTest-GE-Bundle.zip";
        ...
        static public void VariousInputsMain()
        {
            ...
            //update package with new bundle and update activity
            UpdatePackageActivity();

            //post a WorkItem for test locally
            //CreateWorkItem(container, myAct_with_Pack_Name);
        }

        static void UpdatePackageActivity()
        {
                                        ...
                                        string appPackName)
        {
            ...
            var activity = new Activity()
            {
                ...
                {
                    Script = "_tilemode 1 GetTransformByParam transUrl.json output\n"
                ...
                Parameters = new Parameters()
                {
                    InputParameters =
                    {
                        new Parameter()
                        {
                         ...
                         new Parameter()
                        {
                          Name = "transUrl", LocalFileName = "transUrl.json"
                        }
                     },
                    OutputParameters = {
                    new Parameter()
                    {
                        Name = "Result", LocalFileName = "output"
                    }
                  }
                },
                RequiredEngineVersion = "21.0"
        ...
        static void CreateWorkItem(Container container, string actId)
        {
            ...
            wi.Arguments.InputArguments.Add(new Argument()
            {
                ...
                Resource = "https://s3-us-west-2.amazonaws.com/xiaodongforgetestio/xiaodong-test-Inserts-Source.dwg",
            ...
            wi.Arguments.InputArguments.Add(new Argument()
            {
                Name = "transUrl", // Must match the input parameter in activity
 
                Resource = "http://forge-ge-test.herokuapp.com/designauto/getSavedView2DState/Kzxff2",
